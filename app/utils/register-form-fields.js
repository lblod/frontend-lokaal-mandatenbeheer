...
import RDFMadatarisFractieSelectorComponent from 'frontend-lmb/components/rdf-input-fields/mandataris-fractie-selector';
...
export const registerCustomFormFields = () => {
  registerFormFields([
    ...
    },
    {
      ...
      edit: RDFMadatarisFractieSelectorComponent,
    },
  ]);
};
