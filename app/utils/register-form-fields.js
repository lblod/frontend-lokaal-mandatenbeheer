...
import RdfInputFieldsInstanceSelectorWithCreateComponent from 'frontend-lmb/components/rdf-input-fields/instance-selector-with-create';
...
export const registerCustomFormFields = () => {
  registerFormFields([
    ...
    {
      displayType:
        'http://lblod.data.gift/display-types/instanceSelectorWithCreate',
      edit: RdfInputFieldsInstanceSelectorWithCreateComponent,
    },
  ]);
};
