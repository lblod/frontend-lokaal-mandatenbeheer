...
export default class LeidinggevendenbeheerBestuursfunctiesBestuursfunctieFunctionarissenIndexRoute extends Route.extend(
  ...
  async beforeModel() {
    ...
    if (
      ...
      this.router.transitionTo('legacy.leidinggevendenbeheer.bestuursfuncties.index');
    }
  }

  mergeQueryOptions() {
    this.bestuursfunctie = this.modelFor(
      'legacy.leidinggevendenbeheer.bestuursfuncties.bestuursfunctie'
    );
  ...
  setupController(controller) {
    ...
    controller.set('bestuurseenheid', this.modelFor('legacy.leidinggevendenbeheer'));
